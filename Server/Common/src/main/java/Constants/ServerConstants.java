...
public class ServerConstants {
    ...
    public static final String CAR_SERVER_NAME = "lab2-17.cs.mcgill.ca";
    public static final String FLIGHTS_SERVER_NAME = "lab2-11.cs.mcgill.ca";
    public static final String ROOMS_SERVER_NAME = "lab2-35.cs.mcgill.ca";
    ...
    public static final int ROOMS_SERVER_PORT = 1749;
